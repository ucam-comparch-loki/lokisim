...
simdstart:
    ...
    addui.eop           r11, r30, -1            # r11 = current output row
...
helpercode:
    ...
    or.eop              r11, r0,  r0            # r11 = current output row
...
# Compute where to load from in matrix 2
    ...
    seteq.p             r0,  r14, r3    -> 3    # see if we will have finished this result
