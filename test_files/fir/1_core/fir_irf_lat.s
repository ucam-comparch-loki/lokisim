...
loadtaps:
    ...
    iwtr            r17, ch0                # store the tap in the IRF (late)
    addui.eop       r20, r10, 32            # r20 = first register with no tap in it

# Start of outer loop
loop:
    addu            r21, r0,  r0            # r21 = accumulated result
    subu            r18, r16, r26           # r18 = current input element
    ldw             0(r18)         -> 1     # load input data early
    addui           r17, r0,  32            # move back to start of taps
