...
/* Signals (wires) */
  ...
  sc_buffer<short>        decToExRChan, exToWriteRChan;
  sc_signal<bool>         d2eNewRChan, e2wNewRChan;
  sc_buffer<Data>         ALUOutput;

  // To/from write stage
  sc_buffer<short>        writeAddr, indWriteAddr;
