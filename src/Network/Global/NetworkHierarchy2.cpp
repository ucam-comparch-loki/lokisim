...
void NetworkHierarchy2::initialise(const unsigned int components,
  ...
  for (unsigned int tile=0; tile<NUM_COMPUTE_TILES; tile++) {
    InstantCrossbar* xbar = new InstantCrossbar(sc_gen_unique_name("to_router"), // name
                                  ...
                                  components/NUM_COMPUTE_TILES,// inputs from components
                                  1,                   // outputs to router
    ...
    for (uint component=0; component<components/NUM_COMPUTE_TILES; component++)
    ...
    InstantCrossbar* xbar2 = new InstantCrossbar(sc_gen_unique_name("from_router"), // name
                                   ...
                                   components/NUM_COMPUTE_TILES,// outputs to components
