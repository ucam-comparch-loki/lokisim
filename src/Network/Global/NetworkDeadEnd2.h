...
#ifndef SRC_NETWORK_GLOBAL_NETWORKDEADEND2_H_
#define SRC_NETWORK_GLOBAL_NETWORKDEADEND2_H_
...
template<typename T>
class NetworkDeadEnd2: public LokiComponent,
                       public network_source_ifc<T>,
                       public network_sink_ifc<T> {

public:

  NetworkDeadEnd2(const sc_module_name& name, TileID id, string direction) :
      LokiComponent(name),
      id(id),
      direction(direction) {
...
#endif /* SRC_NETWORK_GLOBAL_NETWORKDEADEND2_H_ */
