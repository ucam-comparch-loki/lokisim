...
/* Constructors and destructors */
  WrappedTileComponent(sc_core::sc_module_name name, int ID, TileComponent tc);
...
/* Signals (wires) */
  sc_signal<Word>          *dataToComponent;    // array
  sc_signal<AddressedWord> *dataFromComponent;  // array
