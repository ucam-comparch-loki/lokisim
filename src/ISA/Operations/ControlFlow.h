...
class Fetch : public T {
  Fetch(Instruction encoded) : T(encoded) {fetchChannel = -1;}
...
template<class T>
class PersistentFetch : public Fetch<T> {
  PersistentFetch(Instruction encoded) : Fetch<T>(encoded) {}
...
template<class T>
class NoJumpFetch : public Fetch<T> {
  NoJumpFetch(Instruction encoded) : Fetch<T>(encoded) {}
